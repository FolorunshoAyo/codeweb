...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2023 at 01:32 PM
...
--
-- Dumping data for table `course_lookup`
--

INSERT INTO `course_lookup` (`id`, `user_id`, `course_id`, `completed`, `fully_paid`, `installment`) VALUES
(2, 1, 2, '0', '0', '0');
...
INSERT INTO `deposits` (`deposit_id`, `transaction_ref`, `user_id`, `deposit_amount`, `deposit_status`, `deposit_at`) VALUES
(6, 'TRX-86314709', 1, '2000.00', '1', '2023-02-11 17:00:12');
...
INSERT INTO `guardians` (`guardian_id`, `student_id`, `first_name`, `last_name`, `phone_no`, `email`, `occupation`, `relationship`, `address`, `city`, `state`, `country`) VALUES
(5, 5, 'Edward', 'Shodiya', '08156123462', 'edwardshodiya@gmail.com', 'self-employed', 'father', 'some address', 'Ikorodu', 'Lagos', 'Nigeria');
...
INSERT INTO `staffs` (`staff_id`, `father_first_name`, `father_last_name`, `mother_first_name`, `mother_last_name`, `father_contact`, `mother_contact`, `father_profession`, `mother_profession`, `address`, `sex`, `date_of_birth`, `place_of_birth`, `date_of_hiring`, `years_of_service`, `salary`, `specialty`, `created_at`) VALUES
(1, 'Charles', 'Olusoji', 'Charles', 'Olusoji', '07026790425', '07026790425', 'programmer', 'trader', 'some address', 'm', '2023-02-10', 'Ikorodu', '2023-02-10', 2, '150000.00', 'mobile and web development', '2023-02-11 21:48:40');
...
INSERT INTO `students` (`student_id`, `user_id`, `sex`, `date_of_birth`, `address`, `city`, `state`, `country`, `leads`) VALUES
(5, 1, 'M', '2003-03-23', 'some address', 'Ikorodu', 'Lagos', 'Nigeria', 'education agent, google');
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `username`, `passkey`, `email`, `phone_no`, `profile_avatar`, `reg_status`, `created_at`) VALUES
(1, 'Folorunsho', 'Shodiya', 'foluwizzy', '$2y$10$2ukxRxutw0GgAN0HTk7J/.9OT5iUUjSj1Lug66tRVexEkTKGBF5Eu', 'folushoayomide11@gmail.com', '07087857141', '1675557310.png', '3', '2023-02-05 00:35:10');
