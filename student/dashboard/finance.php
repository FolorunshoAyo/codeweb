                                ...
                                <tbody>
                                    ...
                                    while ($course_payment_details = $sql_fetch_all_course_payments->fetch_assoc()) {
                                        ...
                                        if ($course_payment_details['duration_in_months'] === $course_payment_details['months_paid']) {
                                            $description = $course_payment_details['name'] . " Full Course payment (" . $course_payment_details['duration_in_months'] . " Months)";
                                        } else {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ₦ <?= $course_payment_details['amount_paid'] ?>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dropdown" style="font-size: 10px;">
                                                    ...
                                                    <div class="dropdown-menu" data-dd-path="<?php echo $count ?>">
                                                        <a class="dropdown-menu__link" href="../receipts/<?= $course_payment_details['receipt'] ?>">View Receipt</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown" style="font-size: 10px;">
                                                ...
                                                <div class="dropdown-menu" data-dd-path="<?php echo $count ?>">
                                                    <a class="dropdown-menu__link" href="../receipts/<?= $_details['receipt'] ?>">View Receipt</a>
