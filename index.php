...
<body>
  ...
  <main>
    ...
    <section class="hero-section">
      <div class="hero-container">
        ...
        <div class="hero-image-container">
          ...
          <img src="assets/images/Woman.png" alt="Customer care lady on call" class="hero-image" />
        </div>
      </div>
    </section>
    <section class="services-section" id="services">
      <div class="services-container">
        <h1 class="main-title">Services We Offer</h1>
        <div class="container">
          <div class="row">
    ...
    <section class="portfolio-section">
      <div class="portfolio-container">
        <h1 class="main-title">Our Work</h1>
    ...
    <section class="collaborate-section">
      <div class="collaborate-container">
        <h1 class="main-title">Why you should work with us</h1>
        <div class="container">
          <div class="row">
            <div class="col2 col-sm-12">
              <div class="collaborate-image-container">
                <img src="assets/images/video.png" alt="Dev team brainstorming" class="collaborate-image" />
              </div>
            </div>
            <div class="col2 col-sm-12">
      ...
      <div class="aboutus-container">
        <div class="aboutus-text-box">
          ...
          <p class="text">
            ...
            <b>engineering-as-a-service</b> solutions to businesses and organisations
            accross various industries.
          </p>

          <p class="text">
            From our educational, consumable and digital solutions, we aim to
            facilitate a more <b>technologically driven</b> world.
          </p>
        </div>

        <div class="aboutus-gallery">
          <img src="assets/images/person-taking-measures-wood 1.png" alt="#" class="aboutus-img img1" />
          <img src="assets/images/portrait-young-motivated-carpenter-standing-by-woodworking-machine-his-carpentry-workshop 1.png" alt="#" class="aboutus-img img2" />
          <img src="assets/images/cropped-man-wearing-blue-overall-drawing-furniture-sheet-paper 1.png" alt="#" class="aboutus-img img3" />
        </div>
      </div>
    </section>
        ...
        <div class="container">
          <div class="contactus-form">
            <form id="contact-form">
              ...
              <div class="form-group">
                <input type="number" name="phoneno" id="phoneno" placeholder="Your telephone number" />
              </div>
              <div class="form-group">
  ...
  <script>
    $(function() {
      ...
      smoothScroll(".hero-btn", "#contact-us", 3000);
